...
process_synergy_file_multi <- 
  function(file_path, sheet_name = NULL, layout_type = "default", layout_csv = NULL) {
...
getwd()
list.files(pattern = "plate_layout_25-07-08_E coli_AgNP_56nm_JC RAW.csv")
list.files(pattern = "25-07-08_E.Coli_AgNP_77nm_DP RAW.xlsx")
...
results$wavelength_600$plots$growth_curves
results$wavelength_600$plots$plate_composite
results$wavelength_600$plots$concentrations_panel
results$wavelength_600$plots$qc_plots$layout_validation
